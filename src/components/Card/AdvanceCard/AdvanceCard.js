    ...
    <>
      <div className={styles.advance_card}>
        ...
        <div className={styles.advance_card_content_wrap}>
          ...
          <p className={styles.advance_card_description_first}>{props.description_first}</p>
          <p className={styles.advance_card_description_second}> {props.description_second}</p>
